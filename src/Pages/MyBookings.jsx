...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
         ...
         upcoming bookings in one Place. Plan your trips seamlessly with just 
         a few clicks' align='left'/>
                ...
                w-full border-b border-gray-300 py-6 first: border-t'>
                    ...
                    <div className='flex flex-row md:items-center md:gap-12 mt-3 gap-8'>
                         <div>
                            <p>Check-In :</p>
                            <p className='text-sm
                            text-gray-500'>{new Date(booking.checkInDate).toDateString()}</p>
                         </div>

                         <div>
                            <p>Check-Out :</p>
                            <p className='text-sm
                            text-gray-500'>{new Date(booking?.checkOutDate).toDateString()}</p>
                         </div>
                    </div>
                    ...
                    <div className='flex flex-col items-center justify-center pt-3'>
                        <div className='flex items-center gap-2'>
                            ...
                            <p className={`h-3 w-3 rounded-full ${booking.isPaid 
                                ? "text-green-500" :"text-red-500"
                            }`}>{booking?.isPaid ?"Payment Paid " :"Payment Pending"}</p>
